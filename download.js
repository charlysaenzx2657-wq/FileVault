...
async function verifyToken() {
  ...
  try {
    ...
    // Descargar forzando blob para que no abra vista previa
    await forceDownload(file.downloadUrl, file.name);
...
// Descarga forzada via blob — evita que el navegador abra vista previa
