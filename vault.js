...
const Vault = {
  ...
  async get(token) {
    ...
    return {
      ...
      // Endpoint de descarga con Content-Disposition: attachment
      downloadUrl: `${SUPABASE_URL}/storage/v1/object/authenticated/${BUCKET_NAME}/${row.file_path}`,
      publicUrl: `${SUPABASE_URL}/storage/v1/object/public/${BUCKET_NAME}/${row.file_path}`,
    };
  },
